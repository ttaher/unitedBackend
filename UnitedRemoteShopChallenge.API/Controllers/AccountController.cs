...
namespace UnitedRemoteShopChallenge.API.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var identuser = await userManager.FindByEmailAsync(credentials.Email);

            var result = await signInManager.PasswordSignInAsync(identuser, credentials.Password, false, false);
